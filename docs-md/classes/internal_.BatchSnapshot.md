...
| :------ | :------ | :------ |
| `reactiveItem` | [`ReactivePrimitive`](ReactivePrimitive.md) | The reactive item to snapshot. |
...
src/core/BatchSnapshot.js:13

___

### #reactiveItem

• `Private` **#reactiveItem**: [`ReactivePrimitive`](ReactivePrimitive.md)
